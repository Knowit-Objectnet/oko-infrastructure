...
resource "aws_iam_role" "ecs_execution_role" {
  name = "backend-ecs-execution-role-staging"
...
resource "aws_iam_policy" "ecs_execution_policy" {
  name        = "backend-ecs-execution-policy-staging"
    ...
    Statement = [
      {
        ...
        Effect = "Allow"
        Resource = [
          "arn:aws:ssm:*:*:parameter/staging/backend/*",
          "arn:aws:logs:eu-central-1:624304543898:log-group:backend-staging:*",
...
resource "aws_iam_policy" "ecr_pull_policy" {
  name        = "backend-ecs-ecr-policy-staging"
...
resource "aws_iam_user_policy" "notification_ro" {
  name = "backend-notification-execution-role-staging"
  user = aws_iam_user.notification.name
